...
@onready var left_projectile_emitter: Node3D = $LeftProjectileEmitter
@onready var right_projectile_emitter: Node3D = $RightProjectileEmitter
@onready var animation_player: AnimationPlayer = $catapult/AnimationPlayer
...
func fire():
	animation_player.play("CatapultRotate")
	firing_timer.start()
	firing = true
